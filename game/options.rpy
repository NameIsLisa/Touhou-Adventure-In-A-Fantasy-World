...
define config.name = _("Touhou Adventure In A Fantasy World")
...
define build.name = "TouhouAdventureInAFantasyWorld"
...
define config.save_directory = "TouhouAdventureInAFantasyWorld-1724852769"
